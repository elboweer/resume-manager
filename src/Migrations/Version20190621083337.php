 ...
 */
final class Version20190621083337 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE feedback (id VARCHAR(36) NOT NULL, company_id VARCHAR(36) NOT NULL, summary_id VARCHAR(36) NOT NULL, send_at DATETIME NOT NULL, decision VARCHAR(255) NOT NULL, INDEX IDX_D2294458979B1AD6 (company_id), INDEX IDX_D22944582AC2D45C (summary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE company (id VARCHAR(36) NOT NULL, title VARCHAR(255) NOT NULL, site VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
